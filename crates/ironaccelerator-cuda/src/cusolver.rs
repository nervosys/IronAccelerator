...
pub use sys::{CusolverFillMode as FillMode, CusolverEigMode as EigMode, CusolverStatus};
...
impl CusolverDnHandle {
    pub fn new(device: Arc<drv::Device>) -> Result<Arc<Self>> {
        ...
        unsafe { check("cusolverDnCreate", (f.cusolverDnCreate)(&mut h))?; }
        Ok(Arc::new(Self { handle: h, _device: device }))
    }

    pub fn set_stream(&self, stream: &Stream) -> Result<()> {
        unsafe { check("cusolverDnSetStream", (fns()?.cusolverDnSetStream)(self.handle, stream.raw())) }
    }

    #[inline] pub fn raw(&self) -> sys::CusolverDnHandle { self.handle }

    // ─── LU (Sgetrf) ────────────────────────────────────────────────────────

    /// Workspace elements (f32) required for `getrf_f32` on `[m×n]`.
    pub fn getrf_f32_buffer_size(&self, m: i32, n: i32, a: &mut DeviceBuf<f32>, lda: i32) -> Result<i32> {
        let f = fns()?;
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnSgetrf_bufferSize",
                  (f.cusolverDnSgetrf_bufferSize)(
                      self.handle, m, n,
                      a.device_ptr() as *mut f32, lda, &mut lwork))?;
        }
        Ok(lwork as i32)
    }
    ...
    pub fn getrf_f32(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnSgetrf", (f.cusolverDnSgetrf)(
                self.handle, m, n,
                a.device_ptr() as *mut f32, lda,
    ...
    pub fn getrs_f32(
        &self, op: Op, n: i32, nrhs: i32,
        a: &DeviceBuf<f32>, lda: i32,
        ipiv: &DeviceBuf<i32>,
        b: &mut DeviceBuf<f32>, ldb: i32,
        info: &mut DeviceBuf<i32>,
    ) -> Result<()> {
        let op: CublasOp = op;
        let f = fns()?;
        unsafe {
            check("cusolverDnSgetrs", (f.cusolverDnSgetrs)(
                self.handle, op, n, nrhs,
                a.device_ptr() as *const f32, lda,
                ipiv.device_ptr() as *const c_int,
                b.device_ptr() as *mut f32, ldb,
                info.device_ptr() as *mut c_int,
            ))
        }
    }
    ...
    pub fn potrf_f32_buffer_size(
        &self, fill: FillMode, n: i32,
        a: &mut DeviceBuf<f32>, lda: i32,
    ) -> Result<i32> {
        let f = fns()?;
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnSpotrf_bufferSize",
    ...
    pub fn potrf_f32(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnSpotrf", (f.cusolverDnSpotrf)(
                self.handle, fill, n,
                a.device_ptr() as *mut f32, lda,
                workspace.device_ptr() as *mut f32,
    ...
    pub fn geqrf_f32_buffer_size(
        &self, m: i32, n: i32, a: &mut DeviceBuf<f32>, lda: i32,
    ) -> Result<i32> {
        let f = fns()?;
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnSgeqrf_bufferSize",
    ...
    pub fn geqrf_f32(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnSgeqrf", (f.cusolverDnSgeqrf)(
                self.handle, m, n,
                a.device_ptr() as *mut f32, lda,
    ...
    pub fn getrf_f64_buffer_size(&self, m: i32, n: i32, a: &mut DeviceBuf<f64>, lda: i32) -> Result<i32> {
        let f = fns()?;
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnDgetrf_bufferSize", (f.cusolverDnDgetrf_bufferSize)(
                self.handle, m, n, a.device_ptr() as *mut f64, lda, &mut lwork))?;
        }
        Ok(lwork as i32)
    }
    ...
    pub fn getrf_f64(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnDgetrf", (f.cusolverDnDgetrf)(
                self.handle, m, n,
                a.device_ptr() as *mut f64, lda,
    ...
    pub fn getrs_f64(
        &self, op: Op, n: i32, nrhs: i32,
        a: &DeviceBuf<f64>, lda: i32,
        ipiv: &DeviceBuf<i32>,
        b: &mut DeviceBuf<f64>, ldb: i32,
        info: &mut DeviceBuf<i32>,
    ) -> Result<()> {
        let op: CublasOp = op;
        let f = fns()?;
        unsafe {
            check("cusolverDnDgetrs", (f.cusolverDnDgetrs)(
                self.handle, op, n, nrhs,
                a.device_ptr() as *const f64, lda,
                ipiv.device_ptr() as *const c_int,
                b.device_ptr() as *mut f64, ldb,
                info.device_ptr() as *mut c_int,
            ))
        }
    }
    ...
    pub fn potrf_f64_buffer_size(
        ...
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnDpotrf_bufferSize", (f.cusolverDnDpotrf_bufferSize)(
                self.handle, fill, n, a.device_ptr() as *mut f64, lda, &mut lwork))?;
        }
        Ok(lwork as i32)
    }
    ...
    pub fn potrf_f64(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnDpotrf", (f.cusolverDnDpotrf)(
                self.handle, fill, n,
                a.device_ptr() as *mut f64, lda,
                workspace.device_ptr() as *mut f64,
                workspace.len() as c_int,
    ...
    pub fn geqrf_f64_buffer_size(
        &self, m: i32, n: i32, a: &mut DeviceBuf<f64>, lda: i32,
    ) -> Result<i32> {
        let f = fns()?;
        let mut lwork: c_int = 0;
        unsafe {
            check("cusolverDnDgeqrf_bufferSize", (f.cusolverDnDgeqrf_bufferSize)(
                self.handle, m, n, a.device_ptr() as *mut f64, lda, &mut lwork))?;
        }
        Ok(lwork as i32)
    }
    ...
    pub fn geqrf_f64(
        ...
        let f = fns()?;
        unsafe {
            check("cusolverDnDgeqrf", (f.cusolverDnDgeqrf)(
                self.handle, m, n,
                a.device_ptr() as *mut f64, lda,
...
impl Drop for CusolverDnHandle {
    fn drop(&mut self) {
        if let Ok(f) = fns() {
            unsafe { let _ = (f.cusolverDnDestroy)(self.handle); }
        }
    }
}
