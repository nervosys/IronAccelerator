...
pub use sys::{
    HipblasComputeType as ComputeType, HipblasDataType as DType, HipblasLtEpilogue as Epilogue,
    HipblasOp as Op,
};
...
fn fns() -> Result<&'static sys::HipblasLtFns> {
    sys::fns().map_err(|e| {
        Error::Other(Box::leak(
            format!("hipblasLt not available: {e}").into_boxed_str(),
        ))
    })
}
...
impl BlasLt {
    pub fn new(device: Arc<drv::Device>) -> Result<Arc<Self>> {
        ...
        unsafe {
            check("hipblasLtCreate", (f.hipblasLtCreate)(&mut h))?;
        }
        Ok(Arc::new(Self {
            handle: h,
            _device: device,
    ...
    #[inline]
    pub fn raw(&self) -> sys::HipblasLtHandle {
        self.handle
    }
}
...
impl Drop for BlasLt {
    fn drop(&mut self) {
        if let Ok(f) = fns() {
            unsafe {
                let _ = (f.hipblasLtDestroy)(self.handle);
            }
        }
    }
}
...
impl MatmulDesc {
        ...
        unsafe {
            check(
                ...
                (f.hipblasLtMatmulDescSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatmulDescAttr::TransA,
            ...
            check(
                ...
                (f.hipblasLtMatmulDescSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatmulDescAttr::TransB,
    ...
    pub fn set_epilogue(&mut self, epi: Epilogue) -> Result<()> {
        ...
        unsafe {
            check(
                ...
                (f.hipblasLtMatmulDescSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatmulDescAttr::Epilogue,
    ...
    pub fn set_bias_pointer(&mut self, ptr: HipDeviceptr) -> Result<()> {
        ...
        unsafe {
            check(
                "hipblasLtMatmulDescSetAttribute(BiasPointer)",
                (f.hipblasLtMatmulDescSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatmulDescAttr::BiasPointer,
    ...
    #[inline]
    pub fn raw(&self) -> sys::HipblasLtMatmulDesc {
        self.raw
    }
}
...
impl Drop for MatmulDesc {
    fn drop(&mut self) {
        if let Ok(f) = fns() {
            unsafe {
                let _ = (f.hipblasLtMatmulDescDestroy)(self.raw);
            }
        }
    }
}
...
impl MatrixLayout {
    ...
    pub fn set_batch(&mut self, count: i32, stride: i64) -> Result<()> {
        ...
        unsafe {
            check(
                "hipblasLtMatrixLayoutSetAttribute(BatchCount)",
                (f.hipblasLtMatrixLayoutSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatrixLayoutAttr::BatchCount,
                    &count as *const _ as *const c_void,
                    std::mem::size_of::<i32>(),
                ),
            )?;
            check(
                "hipblasLtMatrixLayoutSetAttribute(StridedBatchOffset)",
                (f.hipblasLtMatrixLayoutSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatrixLayoutAttr::StridedBatchOffset,
    ...
    #[inline]
    pub fn raw(&self) -> sys::HipblasLtMatrixLayout {
        self.raw
    }
}
...
impl Drop for MatrixLayout {
    fn drop(&mut self) {
        if let Ok(f) = fns() {
            unsafe {
                let _ = (f.hipblasLtMatrixLayoutDestroy)(self.raw);
            }
        }
    }
}
...
pub struct Preference {
    raw: sys::HipblasLtMatmulPreference,
}
...
impl Preference {
    ...
    pub fn set_max_workspace(&mut self, bytes: usize) -> Result<()> {
        ...
        unsafe {
            check(
                "hipblasLtMatmulPreferenceSetAttribute(MaxWorkspaceBytes)",
                (f.hipblasLtMatmulPreferenceSetAttribute)(
                    self.raw,
                    sys::HipblasLtMatmulPreferenceAttr::MaxWorkspaceBytes,
    ...
    #[inline]
    pub fn raw(&self) -> sys::HipblasLtMatmulPreference {
        self.raw
    }
}
...
impl Drop for Preference {
    fn drop(&mut self) {
        if let Ok(f) = fns() {
            unsafe {
                let _ = (f.hipblasLtMatmulPreferenceDestroy)(self.raw);
            }
        }
    }
}
...
pub fn heuristic(
    ...
    if returned == 0 {
        return Err(Error::Other(
            "hipblasLtMatmulAlgoGetHeuristic: no algorithms returned",
        ));
    }
    Ok(out)
}
