...
use crate::cublas_lt::{CublasOp, CudaDataType};
...
pub struct CusparseHandle(pub *mut c_void);
#[repr(transparent)]
#[derive(Copy, Clone, Debug, Default)]
pub struct CusparseDnMatDescr(pub *mut c_void);
#[repr(transparent)]
#[derive(Copy, Clone, Debug, Default)]
pub struct CusparseSpMatDescr(pub *mut c_void);
...
pub enum CusparseOrder {
    Row = 0,
    Col = 1,
}
#[repr(u32)]
#[derive(Copy, Clone, Debug)]
pub enum CusparseIndexType {
    U16 = 1,
    I32 = 2,
    I64 = 3,
}
#[repr(u32)]
#[derive(Copy, Clone, Debug)]
pub enum CusparseIndexBase {
    Zero = 0,
    One = 1,
}
#[repr(u32)]
#[derive(Copy, Clone, Debug)]
pub enum CusparseSpMMAlg {
    Default = 0,
    CsrAlg1 = 4,
    CsrAlg2 = 6,
    CsrAlg3 = 12,
...
#[inline]
pub fn fns() -> Result<&'static CusparseFns, &'static LoadError> {
    FNS.as_ref()
}
