...
pub struct CublasLtHandle(pub *mut c_void);
#[repr(transparent)]
#[derive(Copy, Clone, Debug, Default)]
pub struct CublasLtMatmulDesc(pub *mut c_void);
#[repr(transparent)]
#[derive(Copy, Clone, Debug, Default)]
pub struct CublasLtMatrixLayout(pub *mut c_void);
#[repr(transparent)]
#[derive(Copy, Clone, Debug, Default)]
pub struct CublasLtMatmulPreference(pub *mut c_void);

unsafe impl Send for CublasLtHandle {}
unsafe impl Sync for CublasLtHandle {}
unsafe impl Send for CublasLtMatmulDesc {}
unsafe impl Sync for CublasLtMatmulDesc {}
unsafe impl Send for CublasLtMatrixLayout {}
unsafe impl Sync for CublasLtMatrixLayout {}
unsafe impl Send for CublasLtMatmulPreference {}
unsafe impl Sync for CublasLtMatmulPreference {}
...
pub enum CudaDataType {
    ...
    R8F_E4M3 = 28,
    R8F_E5M2 = 29,
    // CUDA 12.8+/13.x narrow float types. Values per `library_types.h`.
    R6F_E2M3 = 33,
    R6F_E3M2 = 34,
    R4F_E2M1 = 35,
    // Block-scaled companion scale formats used with MXFP8/MXFP4 recipes.
    R8F_UE8M0 = 41,
    R8F_UE4M3 = 42,
}
...
impl CublasOp {
    ...
    pub const CUBLAS_OP_N: Self = Self::N;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_OP_T: Self = Self::T;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_OP_C: Self = Self::C;
}

impl CublasStatus {
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_STATUS_SUCCESS: Self = Self::Success;
}

impl CublasComputeType {
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_COMPUTE_16F: Self = Self::F16;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_COMPUTE_32F: Self = Self::F32;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_COMPUTE_32F_FAST_16F: Self = Self::F32FastF16;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_COMPUTE_32F_FAST_TF32: Self = Self::F32FastTf32;
    #[allow(non_upper_case_globals)]
    pub const CUBLAS_COMPUTE_64F: Self = Self::F64;
}

impl CudaDataType {
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_16F: Self = Self::R16F;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_16BF: Self = Self::R16BF;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_32F: Self = Self::R32F;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_64F: Self = Self::R64F;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_8I: Self = Self::R8I;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_8U: Self = Self::R8U;
    #[allow(non_upper_case_globals)]
    pub const CUDA_R_32I: Self = Self::R32I;
}
...
pub struct CublasLtFns {
    ...
    pub cublasLtMatmul: unsafe extern "C" fn(
        ...
        *const c_void, // alpha
        *const c_void,
        CublasLtMatrixLayout, // A
        *const c_void,
        CublasLtMatrixLayout, // B
        *const c_void,        // beta
        *const c_void,
        CublasLtMatrixLayout, // C
        *mut c_void,
        CublasLtMatrixLayout, // D
        *const c_void,        // algo (opaque)
        *mut c_void,
        usize, // workspace, bytes
        CUstream,
    ) -> CublasStatus,
}
...
static FNS: LazyLock<Result<CublasLtFns, LoadError>> = LazyLock::new(|| {
    ...
    unsafe {
        Ok(CublasLtFns {
            ...
            cublasLtMatrixLayoutSetAttribute: sym(
                lib,
                "cublasLt",
                "cublasLtMatrixLayoutSetAttribute",
            )?,
            cublasLtMatmulPreferenceCreate: sym(lib, "cublasLt", "cublasLtMatmulPreferenceCreate")?,
            cublasLtMatmulPreferenceDestroy: sym(
                lib,
                "cublasLt",
                "cublasLtMatmulPreferenceDestroy",
            )?,
            cublasLtMatmulPreferenceSetAttribute: sym(
                lib,
                "cublasLt",
...
#[inline]
pub fn fns() -> Result<&'static CublasLtFns, &'static LoadError> {
    FNS.as_ref()
}
