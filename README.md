...
| ------------------------------------- | --------------- | ------------ | --------------------- |
| **[`MemPool`] alloc+free (any size, warm)** | **~21 ns**| ~1000 ns     | Iron **~48× faster**  |
