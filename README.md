...
| ------------------------------------- | --------------- | ------------ | --------------------- |
| **[`MemPool`] alloc+free (any size, warm)** | **~7 ns** | ~1000 ns     | Iron **~145× faster** |
