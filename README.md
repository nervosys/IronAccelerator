...
| ------------------------------------- | --------------- | ------------ | --------------------- |
| **[`MemPool`] alloc+free (any size, warm)** | **~29 ns**| ~970 ns      | Iron **~33× faster**  |
